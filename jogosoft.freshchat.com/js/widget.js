!(function () {
  ...
  (n.p = "https://assetscdn-wchat.eu.freshchat.com/static/assets/"),
    (function () {
      "use strict";
      var e = {
        ...
        p = function () {
          ...
          return {
            setProperties: function (n) {
              ...
              for (var a in (i = n.fc_override_bot_property)) e[a] = i[a];
              for (var r in e)
                for (var s in t) e[r].hasOwnProperty(s) || (e[r][s] = t[s]);
        ...
        v = {
          ...
          getAgent:
            ...
            -1 !== (r = l.indexOf("Opera"))
              ? ((u = "Opera"),
                (f = l.substring(r + 6)),
                -1 !== (r = l.indexOf("Version")) && (f = l.substring(r + 8)))
              : -1 !== (r = l.indexOf("MSIE"))
              ? ((u = "Microsoft Internet Explorer"), (f = l.substring(r + 5)))
              : -1 !== (r = l.indexOf("Edge"))
              ? ((u = "Edge"), (f = l.substring(r + 5)))
              : -1 !== (r = l.indexOf("Trident"))
              ? ((u = "Trident"), (f = l.substring(r + 8)))
              : -1 !== (r = l.indexOf("Chrome"))
              ? ((u = "Chrome"), (f = l.substring(r + 7)))
              : -1 !== (r = l.indexOf("Safari"))
              ? ((u = "Safari"),
                (f = l.substring(r + 7)),
                -1 !== (r = l.indexOf("Version")) && (f = l.substring(r + 8)))
              : -1 !== (r = l.indexOf("Firefox"))
              ? ((u = "Firefox"), (f = l.substring(r + 8)))
              : ("MacIntel" === navigator.platform &&
                ...
                -1 !== l.indexOf("iPod") ||
                -1 !== l.indexOf("wv")
              ? ((u = "WebView"), (f = l.substring(r + 8)))
              : (a = l.lastIndexOf(" ") + 1) < (r = l.lastIndexOf("/")) &&
                ((u = l.substring(a, r)),
                (f = l.substring(r + 1)),
        ...
        return {
          ...
          add: function () {
            ...
            (i && "DIV" === i.tagName) ||
              ...
              r && r.headerProperty
                ? ("ltr" === r.headerProperty.direction &&
                    i.classList.add("fc_l2r"),
                  r.headerProperty.hideChatButton ||
              ...
              i.appendChild(a);
            var d = r && r.widgetCanary ? e.canaryRoutes.feature : "";
            ...
            (r =
              !g || ("botflow" !== g && "autofaq" !== g)
                ...
                : ""
                    ...
                    .concat(t, "?token=")
                    .concat(n, "&referrer=")
                    .concat(a, "&previewMode=")
                    .concat(g)),
              i && (r += "&widgetUuid=".concat(i)),
              k && (r += "&eagerLoad=true"),
              this.load(r, e.frameId, o);
          },
          remove: function (e) {
            v.remove(e), (t = null);
          },
          setFrameSize: function () {
            ...
            !0 === r && d.classList.add(e.classes.fullscreenClass),
              a && a.length > 0 && (s = "fc-widget-" + a.toLowerCase()),
              d.classList.add(s);
          },
          setFramePosition: function () {
            var t,
              ...
              s =
                "BOTTOM_LEFT" ===
                (null == a || null === (t = a.appearanceConfig) || void 0 === t
                  ? void 0
                  : t.widgetPosition),
              d =
                null == a || null === (n = a.appearanceConfig) || void 0 === n
                  ? void 0
                  : n.widgetBottomOffsetPx,
              c =
                null == a || null === (i = a.appearanceConfig) || void 0 === i
                  ? void 0
                  : i.widgetRightOffsetPx;
            if (
              "TEXT" ===
              (null == a || null === (o = a.appearanceConfig) || void 0 === o
                ? void 0
              ...
              (u.innerText =
                null == a || null === (l = a.appearanceConfig) || void 0 === l
                  ? void 0
            ...
            (r.style.bottom = "".concat(d || 15, "px")),
              s
                ? (r.classList.add("fc-widget-left"),
                  (r.style.left = "".concat(c || 15, "px")))
                : (r.style.right = "".concat(c || 15, "px"));
          },
      ...
      var O = function () {
          ...
          var t = null,
            ...
            l = function () {
              T(this, e), (n = new Date().getTime()), o(), d(), r(!1);
            }.bind(this),
            u = function () {
            ...
            oe(t, [
              {
                ...
                value: function () {
                  ...
                  return function (t) {
                    ...
                    var r = e.impostor.tagName,
                      ...
                      d = (function (e) {
                        ...
                        function l() {
                          var e, t;
                          ne(this, l),
                            ae(K((t = c.call(this))), "onDemandCB", void 0),
                            t
                              .attachShadow({
                                mode: "open",
                              })
                    ...
                    customElements.get(r) || customElements.define(r, d);
                  ...
                  (this.appConfigService = new G(this.payload)),
                    (function (e, t) {
                      ...
                      function (n) {
                        ...
                        he(this, t);
                        var o,
                          a = null == n ? void 0 : n.betaFeatures;
                        (this.appConfig = n),
                          (this.impostorConfig = this.getImpostorConfig()),
                          this.eagerLoad ||
                          !a ||
                          -1 !== a.indexOf(e.eagerLoadBetaFeature)
      ...
      var _e = function () {
        ...
        return {
          init: function (i) {
            ...
            window.Promise && !n
              ? (n = new me(i)).init(i).then(a, function () {})
              : a();
          },
          destroy: function (e) {
            x.unload(), w.unload(e);
      ...
      if ((window.fcWidget || (window.fcWidget = _e), window.fcSettings))
        if (
          ...
          ke && "function" == typeof ke && ke(),
            window.fcSettings.token &&
              window.fcSettings.host &&
              _e.init(window.fcSettings);
        } else
